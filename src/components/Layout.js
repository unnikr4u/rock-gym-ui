      ...
      <div className={`fixed inset-0 z-50 lg:hidden ${sidebarOpen ? 'block' : 'hidden'}`}>
        ...
        <div className="fixed inset-y-0 left-0 flex w-64 flex-col bg-white">
          <div className="flex h-16 items-center justify-between px-4 flex-shrink-0">
            <h1 className="text-xl font-bold text-gray-900">Rock Gym</h1>
          ...
          <div className="border-t border-gray-200 p-4 flex-shrink-0">
            ...
            <Link
              to="/change-password"
              className="flex w-full items-center px-2 py-2 mb-2 text-sm font-medium text-gray-600 hover:bg-gray-50 hover:text-gray-900 rounded-md"
              onClick={() => setSidebarOpen(false)}
            >
